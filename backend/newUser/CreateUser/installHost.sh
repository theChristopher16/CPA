...
if [[ $(hostname) = Wyly ]]; then
    ...
    sudo python /home/winadmin/Challenges/binary/binary7.py "The password to GTM (10.16.17.8) is: " ${arr[5]} | sudo tee /home/$usn/Challenge1/challenge.txt
    sudo cp /home/winadmin/descriptions/Wyly /home/$usn/Challenge1/README.txt
    sudo mkdir /home/$usn/Challenge2
    echo -n "Your password to Keeny (10.16.17.5) is: ${arr[1]}" | sudo tee /home/winadmin/Challenges/tempstuff/challenge.txt
...
# ENGINEERING ANNEX
			...
			echo "The password to Nethken (10.16.17.3) is: ${arr[17]}" | sudo tee /home/winadmin/Challenges/tempstuff/PASSWORD
			sudo python /home/winadmin/Challenges/supersteg/xor.py /home/winadmin/Challenges/supersteg/fullkey.bmp < /home/winadmin/Challenges/tempstuff/PASSWORD | sudo tee /home/$usn/Challenge/PASSWORD
...
# WOODARD
                ...
                sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                sudo mkdir /home/$usn/Challenge
                echo "The password to Band Building (10.16.17.15) is: ${arr[8]}" | sudo tee /home/winadmin/Challenges/tempstuff/steg2file
                sudo python /home/winadmin/Challenges/steg/steg.py -b -s -o729 -w/home/winadmin/Challenges/steg/steg2/dog3.bmp -h/home/winadmin/Challenges/tempstuff/steg2file | sudo tee /home/$usn/Challenge/dog3.bmp
...
# COBB
                    ...
                    echo "python steg.py [-bB] -r -o[offset] -i[interval] -w[wrapper]" | sudo tee /home/$usn/syntax.txt
...
# HALE
                        ...
                        sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                        sudo mkdir /home/$usn/Challenge
                        sudo python /home/winadmin/Challenges/binary/binary7.py "The password to Woodard (10.16.17.13) is: " ${arr[5]} | sudo tee /home/$usn/Challenge/challenge.txt
...
# STUDENT CENTER
                            ...
                            sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                            sudo mkdir /home/$usn/Challenge
                            sudo python /home/winadmin/Challenges/caesar/caesar.py "The password for Tolliver (10.16.17.12) is: " ${arr[12]} "12" | sudo tee /home/$usn/Challenge/challenge.txt
...
# BOGARD
                                ...
                                echo "The password to CTH (10.16.17.6) is: ${arr[15]}" | sudo tee /home/winadmin/Challenges/tempstuff/xorfile
                                sudo python /home/winadmin/Challenges/xor/xor.py t-rex.bmp < /home/winadmin/Challenges/tempstuff/xorfile | sudo tee /home/$usn/Challenge/key
...
# NEETHKEN
                                        ...
                                        sudo cp /home/winadmin/bashrc_backup /home/$usn/.bashrc
                                        sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
						    echo "Congratulations $usn!!! You've completed all of the CPA cyber challenges!" | sudo tee /home/$usn/winner.txt
...
# GTM
                                            ...
                                            sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                                            sudo mkdir /home/$usn/Challenge
                                            echo "The password for Hale (10.16.17.7) is: ${arr[6]}" | sudo tee /home/winadmin/Challenges/tempstuff/steg1file
                                            sudo python /home/winadmin/Challenges/steg/steg.py -B -s -o1024 -i8 -w/home/winadmin/Challenges/steg/steg1/cat1.bmp -h/home/winadmin/Challenges/tempstuff/steg1file | sudo tee /home/$usn/Challenge/cat1.bmp
...
# SOUTH HALL
                                                ...
                                                echo "The password for IFM (10.16.17.16) is: ${arr[10]}" | sudo tee /home/winadmin/Challenges/tempstuff/steg3file
                                                sudo python /home/winadmin/Challenges/steg/steg.py -b -s -o2938 -w/home/winadmin/Challenges/steg/steg3/dogpassword.bmp -h/home/winadmin/Challenges/tempstuff/steg3file | sudo tee /home/winadmin/Challenges/tempstuff/dogtohide
                                                sudo python /home/winadmin/Challenges/steg/steg.py -B -s -o2005 -i6 -w/home/winadmin/Challenges/steg/steg3/dogcat2.bmp -h/home/winadmin/Challenges/tempstuff/dogtohide | sudo tee /home/$usn/Challenge/dogcat2.bmp
...
# KEENY
                                                    ...
                                                    sudo mkdir /home/$usn/Challenge1
                                                    echo -n "The password for University Hall (10.16.17.19) is: ${arr[2]}" | sudo tee /home/winadmin/Challenges/tempstuff/passwordmd5.txt | ccrypt -K "place" /home/winadmin/Challenges/tempstuff/passwordmd5.txt
                                                    mv /home/winadmin/Challenges/tempstuff/passwordmd5.txt.cpt /home/$usn/Challenge1/password.txt
                                                    echo -n "place" | md5sum | sudo tee /home/$usn/Challenge1/challenge.txt
                                                    sudo cp /home/winadmin/descriptions/Keeny /home/$usn/Challenge1/README.txt
                                                    sudo mkdir /home/$usn/Challenge2
                                                    echo -n "The password for COBB (10.16.17.14) is: ${arr[3]}" | base64 | sudo tee /home/$usn/Challenge2/challenge.txt
                                                    sudo cp /home/winadmin/descriptions/Keeny2 /home/$usn/Challenge2/README.txt
                                                    sudo mkdir /home/$usn/Challenge3
                                                    echo -n "The password for Howard (10.16.17.10) is: ${arr[2]}" | sudo tee /home/winadmin/Challenges/tempstuff/passwordsha512.txt | ccrypt -K "Heaven" /home/$usn/Challenge3/passwordsha512.txt
                                                    sudo mv /home/winadmin/Challenges/tempstuff/passwordsha512.txt.cpt /home/$usn/Challenge3/password.txt
                                                    echo -n "Heaven" | sha512 | sudo tee /home/$usn/Challenge3/challenge.txt
...
# UNIVERSITY HALL
                                                        ...
                                                        echo "python xor.py [key file] < [encrypted file] | sudo tee [decrypted file]" | sudo tee /home/$usn/syntax.txt
...
# POWER PLANT
                                                            ...
                                                            sudo python /home/winadmin/Challenges/vigenere/vigenere_encode.py "The password for IFM (10.16.17.16) is: " ${arr[10]} "kinds" | sudo tee /home/$usn/Challenge/challenge.txt
...
# BAND BUILDING
                                                                ...
                                                                sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                                                                sudo mkdir /home/$usn/Challenge
                                                                sudo python /home/winadmin/Challenges/binary/binaryvertical.py "The password for South Hall (10.16.17.17) is: " ${arr[9]} | sudo tee /home/$usn/Challenge/challenge.txt
...
# TOLLIVER
								    ...
								    printf  "${arr[12]}\n${arr[12]}\n\n\n\n\n\n\n" | sudo adduser $usn
                                                                    ...
                                                                    sudo mkdir /home/$usn/Challenge
                                                                    sudo cp /home/winadmin/Challenges/shortdictionary.txt /home/$usn/Challenge/dictionary.txt
                                                                    sudo python /home/winadmin/Challenges/abraxas/abraxas.py "The password for the Power Plant (10.16.17.18) is: " ${arr[11]} "Obama" | sudo tee /home/$usn/Challenge/challenge.txt
...
# CTH
                                                                        ...
                                                                        sudo cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                                                                        sudo mkdir /home/$usn/Challenge
                                                                        echo "Half of the password for the Engineering Annex (10.16.17.7) is: ${arr[16]}" | sudo tee /home/$usn/Challenge/halfpassword.txt
