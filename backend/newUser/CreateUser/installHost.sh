...
if [[ $(hostname) = Wyly ]]; then
    ...
    cp /home/winadmin/descriptions/Wyly /home/$usn/Challenge1/README.txt
    ...
    cp /home/winadmin/descriptions/Wyly2 /home/$usn/Challenge2/README.txt
...
# IFM
        ...
        printf  "${arr[10]}\n${arr[10]}\n\n\n\n\n\n\n" | sudo adduser $usn
        sudo usermod -g player $usn
        cp /home/winadmin/descriptions/IFM /home/$usn/README.txt
        cp /home/winadmin/bashrc_backup /home/$usn/.bashrc
        cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
# ENGINEERING ANNEX
...
# WOODARD
                ...
                cp /home/winadmin/Challenges/steg/steg2/dog1.bmp /home/$usn/Challenge/dog1.bmp
                cp /home/winadmin/Challenges/steg/steg2/dog2.bmp /home/$usn/Challenge/dog2.bmp
                rm /home/winadmin/Challenges/tempstuff/steg2file
                cp /home/winadmin/descriptions/Woodard /home/$usn/Challenge/README.txt
...
# COBB
                    ...
                    cp /home/winadmin/bashrc_backup /home/$usn/.bashrc
                    cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
					cp /home/winadmin/Challenges/steg/steg_encode.py /home/winadmin/Challenges/tempstuff/steg.py
                    chmod 111 /home/winadmin/Challenges/tempstuff/steg.py
...
# HALE
                        ...
                        cp /home/winadmin/descriptions/Hale /home/$usn/Challenge/README.txt
...
# STUDENT CENTER
                            ...
                            cp /home/winadmin/descriptions/StudentCenter /home/$usn/Challenge/README.txt
...
# BOGARD
                                ...
                                cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                                mkdir /home/$usn/Challenge
                                cp /home/winadmin/Challenges/xor/t-rex.bmp /home/$usn/Challenge/t-rex.bmp
                                cp /home/winadmin/Challenges/xor/dodo.bmp /home/$usn/Challenge/dodo.bmp
                                cp /home/winadmin/Challenges/xor/mammoth.bmp /home/$usn/Challenge/mammoth.bmp
                                ...
                                cp /home/winadmin/descriptions/Bogard /home/$usn/Challenge/README.txt
...
# HOWARD
                                    ...
                                    cp /home/winadmin/descriptions/Howard /home/$usn/Challenge1/README.txt
                                    mkdir /home/$usn/Challenge2
                                    ...
                                    cp /home/winadmin/descriptions/Howard2 /home/$usn/Challenge2/README.txt
...
# GTM
                                            ...
                                            cp /home/winadmin/Challenges/steg/steg1/cat2.bmp /home/$usn/Challenge/cat2.bmp
                                            cp /home/winadmin/Challenges/steg/steg1/cat3.bmp /home/$usn/Challenge/cat3.bmp
                                            rm /home/winadmin/Challenges/tempstuff/steg1file
                                            cp /home/winadmin/descriptions/GTM /home/$usn/Challenge/README.txt
...
# SOUTH HALL
                                                ...
                                                cp /home/winadmin/Challenges/steg/steg3/dogcat1.bmp /home/$usn/Challenge/dogcat1.bmp
                                                cp /home/winadmin/Challenges/steg/steg3/hiddendogcat3.bmp /home/$usn/Challenge/dogcat3.bmp
                                                rm /home/winadmin/Challenges/tempstuff/steg3file /home/winadmin/Challenges/tempstuff/dogtohide
                                                cp /home/winadmin/descriptions/SouthHall /home/$usn/Challenge/README.txt
...
# KEENY
                                                    ...
                                                    printf  "${arr[1]}\n${arr[1]}\n\n\n\n\n\n\n" | sudo adduser $usn
                                                    sudo usermod -g player $usn
                                                    cp /home/winadmin/Challenges/shortdictionary.txt /home/$usn/dictionary.txt
                                                    mkdir /home/$usn/Challenge1
                                                    ...
                                                    cp /home/winadmin/descriptions/Keeny /home/$usn/Challenge1/README.txt
                                                    mkdir /home/$usn/Challenge2
                                                    echo -n "The password for COBB (10.16.17.14) is: ${arr[3]}" | base64 > /home/$usn/Challenge2/challenge.txt
                                                    cp /home/winadmin/descriptions/Keeny2 /home/$usn/Challenge2/README.txt
                                                    ...
                                                    mv /home/winadmin/Challenges/tempstuff/passwordsha512.txt.cpt /home/$usn/Challenge3/password.txt
                                                    echo -n "Heaven" | sha512 > /home/$usn/Challenge3/challenge.txt
                                                    cp /home/winadmin/descriptions/Keeny3 /home/$usn/Challenge3/README.txt
...
# UNIVERSITY HALL
                                                        ...
                                                        cp /home/winadmin/bashrc_backup /home/$usn/.bashrc
                                                        cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
														cp /home/winadmin/Challenges/xor/xor.py /home/winadmin/Challenges/tempstuff/xor.py
                                                        chmod 111 /home/winadmin/Challenges/tempstuff/xor.py
                                                        mv /home/winadmin/Challenges/tempstuff/xor.py /home/$usn/xor.py
...
# POWER PLANT
                                                            ...
                                                            cp /home/winadmin/bash_logoutBackup /home/$usn/.bash_logout
                                                            mkdir /home/$usn/Challenge
                                                            cp /home/winadmin/Challenges/shortdictionary.txt /home/$usn/Challenge/dictionary.txt
                                                            ...
                                                            cp /home/winadmin/descriptions/PowerPlant /home/$usn/Challenge/README.txt
...
# BAND BUILDING
                                                                ...
                                                                cp /home/winadmin/descriptions/Band /home/$usn/Challenge/README.txt
...
# TOLLIVER
								    ...
								    printf  "${arr[12]}\n${arr[12]}\n\n\n\n\n\n\n" | sudo adduser $usn
                                                                    ...
                                                                    cp /home/winadmin/descriptions/Tolliver /home/$usn/Challenge/README.txt
...
# CTH
                                                                        ...
                                                                        cp /home/winadmin/descriptions/CTH /home/$usn/Challenge/README.txt
 								      else
